#!/usr/bin/env fish
# Tide v6 theme — Catppuccin Mocha (original, restored + bug-fixed:
# tide_git_truncation_strategy must be '' — a literal ellipsis char
# there breaks `string shorten`'s flag parsing).
