...
# Monochrome graphite/gray powerline segments, emerald green as the
# recurring accent (character, status, git, jobs, python). Purple/
# peach dialed back to rare secondary touches only.
# Run by install.sh after fisher installs tide.

set -U _tide_left_items 'os' 'pwd' 'git' 'newline' 'character'
set -U _tide_right_items 'status' 'cmd_duration' 'context' 'docker' 'shlvl' 'jobs' 'node' 'python' 'java' 'ruby' 'time'
...
set -U tide_cmd_duration_bg_color '4A4D55'
set -U tide_cmd_duration_color 'D6D9DE'
set -U tide_cmd_duration_decimals '0'
set -U tide_cmd_duration_icon ''
set -U tide_cmd_duration_threshold '3000'
set -U tide_context_always_display 'true'
set -U tide_context_bg_color '2A2D33'
set -U tide_context_color_default '9BA0AB'
...
set -U tide_docker_bg_color '2A2D33'
...
set -U tide_git_bg_color '33363D'
set -U tide_git_bg_color_unstable '4A4D55'
...
set -U tide_jobs_bg_color '2A2D33'
...
set -U tide_node_bg_color '2A2D33'
set -U tide_node_color '7DD3C0'
set -U tide_node_icon ''
set -U tide_os_bg_color '191B20'
...
set -U tide_prompt_color_frame_and_connection '4A4D55'
set -U tide_prompt_color_separator_same_color '33363D'
...
set -U tide_pwd_bg_color '2A2D33'
set -U tide_pwd_color_anchors 'E4E6EB'
set -U tide_pwd_color_dirs 'C7CAD1'
...
set -U tide_python_bg_color '2A2D33'
set -U tide_python_color '34D399'
set -U tide_python_icon '󰌠'
set -U tide_right_prompt_frame_enabled 'false'
set -U tide_right_prompt_items 'status' 'cmd_duration' 'context' 'docker' 'shlvl' 'jobs' 'direnv' 'bun' 'node' 'python' 'rustc' 'java' 'php' 'pulumi' 'ruby' 'go' 'gcloud' 'kubectl' 'distrobox' 'toolbox' 'terraform' 'aws' 'nix_shell' 'crystal' 'elixir' 'zig' 'time'
...
set -U tide_shlvl_bg_color '2A2D33'
...
set -U tide_time_bg_color '2A2D33'
